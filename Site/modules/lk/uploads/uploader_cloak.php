...
if (strpos($mime, 'image/png') === false) {
	...
	echo'<HTML>
  <HEAD>
    <META HTTP-EQUIV="REFRESH" CONTENT="0; URL=https://UniversalStudio.online/cabinet?no_image ">
  </HEAD>
  <BODY>
  </BODY>
</HTML>';
...
if ($hd_cloak=="cloak_good" || $hd_cloak=="hd_cloak_good") {
	...
	//header('Location: https://UniversalStudio.online/cabinet?cloak_error');
	echo'<HTML>
  <HEAD>
    <META HTTP-EQUIV="REFRESH" CONTENT="0; URL=https://UniversalStudio.online/cabinet?cloak_error ">
  </HEAD>
  <BODY>
  </BODY>
</HTML>';
...
if (!move_uploaded_file($filePath, __DIR__ . '/cloaks/'  .$login . '.png')) {
	...
	//header('Location: https://UniversalStudio.online/cabinet?cloak_success');
	echo'<HTML>
  <HEAD>
    <META HTTP-EQUIV="REFRESH" CONTENT="0; URL=https://UniversalStudio.online/cabinet?cloak_success ">
  </HEAD>
  <BODY>
  </BODY>
</HTML>';

...
file_put_contents('ajax.json', json_encode(utf8ize($resp), true));
$arPlayer = array('игрок','игрока','игроков');
file_put_contents('discord/online.txt', $resp['online'].' '.declension_words($resp['online'],$arPlayer));
file_put_contents('discord/recordday.txt', $resp['recordday'].' '.declension_words($resp['recordday'],$arPlayer));
